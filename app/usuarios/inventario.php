    ...
    <script>
        ...
        function previsualizarImagenes(event) {
            ...
            if (archivosRechazados.length > 0) {
                ...
                alert(`⚠️ Los siguientes archivos exceden el tamaño máximo de ${MAX_IMAGE_SIZE_MB}MB y no se pueden adjuntar:\n\n${mensajesError}\n\n${archivosValidos.length > 0 ? `✅ ${archivosValidos.length} archivo(s) válido(s) se agregará(n).` : 'Por favor, selecciona archivos más pequeños.'}`);
            }
        ...
        document.getElementById('formAgregarFactura').addEventListener('submit', function(e) {
            ...
            .catch(error => {
                ...
                alert('❌ Error al agregar la factura: ' + error.message);
            })
            .finally(() => {
        ...
        function generarReporte() {
            ...
            if (confirm('¿Deseas generar el reporte de tu inventario?')) {
